...
<div class="container-fluid">
	<div class="Top-bar">
		...
		<div class="col-md-12">
		    <marquee width="100%" direction="left" height="50px">
		        <h4 class="text-dark mt-2">Welcome to User Panel.Please login to give exam<h4>
	        </marquee>
		</div>
				...
				<div class="col-md-12 bg-dark">
					<nav class="navbar navbar-expand-sm sticky-top">
						...
						<li class="nav-item mr-3">
							<a href="signup.php"><button class="btn btn-primary">Signup</button>
						</a>
						...
						<li class="nav-item mr-3">
							<a href="index.php"><button class="btn btn-success">Login</button>
						</a>
						</li>
						<li class="nav-item">
						<a href="home.php"><button class="btn btn-danger" data-toggle="modal" data-target="">Back</button></a>
						</li>
						</ul>
					</nav>
				</div>
	...
	<div class="row">
		<div class="col-md-12">
		<img src="image/user.png" alt="" style="width: 100%;">
		</div>
	</div>
...
<!--last section-->
		<div class="row mx-auto bg-dark mt-5">
			...
			<div class="col-md-3 mt-5 mb-4">
				...
				<a href="user.php" class="text-info" style="font-size: 14px;">Top</a><br><br>
